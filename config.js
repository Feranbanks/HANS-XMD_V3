...
module.exports = { session: process.env.SESSION_ID || 'HansTz&X5A03CiA#eTsuYydvYeuALkjAePFe8n_eecNX6yPmFAG5n1Y91yw',
    PREFIXE: process.env.PREFIX || ".",
    OWNER_NAME: process.env.OWNER_NAME || "HANS-XMD",
    NUMERO_OWNER : process.env.NUMERO_OWNER || " 2347031872859",              
